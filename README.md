...
| `docs/english_discord_season6_delta_2026-05-13.md` | 公式英語版Discord `#season-6` から、日本語版に薄かった差分だけを抽出した根拠メモ |
| `docs/japanese_discord_season6_delta_2026-05-13.md` | 公式日本語Discord `#🐊シーズン6-シャドウジャングル` HTML全件走査の差分メモ |
