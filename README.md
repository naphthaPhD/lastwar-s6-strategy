...
| `strategy/534_ooda_sunzi_frame.md` | OODAループと孫子を#534の遅滞・中央妨害・限定反撃へ落とした幹部向け判断フレーム |
...
| `strategy/jdx_todo_2026-05-18.md` | 2026-05-18 #534幹部chatから抽出したJDX即応タスク。中央#8061囲い込み、#503進路妨害、安全時間変更後の調整、476外交の扱い |
...
| `docs/english_discord_season6_delta_2026-05-13.md` | 公式英語版Discord `#season-6` HTML走査の差分メモ。2026-05-16更新版まで反映 |
| `docs/japanese_discord_season6_delta_2026-05-13.md` | 公式日本語Discord `#🐊シーズン6-シャドウジャングル` HTML全件走査の差分メモ。2026-05-16更新版まで反映 |
