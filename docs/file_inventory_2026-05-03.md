...
| `docs/english_discord_season6_delta_2026-05-13.md` | 公式英語版Discord `#season-6` のHTML差分抽出。2026-05-16更新版までのStaff・Mod・Advisor回答と要確認の観測を分離 |
| `docs/japanese_discord_season6_delta_2026-05-13.md` | 公式日本語Discord `#🐊シーズン6-シャドウジャングル` HTML全件走査の差分抽出。2026-05-16更新版までの盟約・寄付・漁場実務補強を分離 |
...
| `strategy/jdx_todo_2026-05-18.md` | 2026-05-18 #534幹部chatから抽出したJDX即応タスク。中央#8061対応と476外交の扱い |
