...
- The generated map includes Phase 3 score buttons: `Phase3攻撃TOP`, `Phase3遮断TOP`, `Phase3危険TOP`, and `Phase3総合TOP`. These open a score panel from the embedded `invasion_simulation` JSON, list the top candidates with score reasons, and highlight/select the corresponding edge or node.
