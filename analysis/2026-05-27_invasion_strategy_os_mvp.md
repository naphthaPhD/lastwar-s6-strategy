...
- The current full-map output reads the management-table sheet, includes the central area, and contains 2,165 nodes with 5,620 coordinate-rule tactical edges.
