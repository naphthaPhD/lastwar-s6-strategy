...
23. Added edge-highlight controls to the generated HTML map: selecting a fishery highlights its connected edges in cyan, `境界強調` highlights #534-side fishery to enemy-side fishery edges in orange and enemy-side fishery to unowned fishery edges in amber, `境界+内側` additionally highlights #534-side self-to-self fishery edges touching #534/enemy boundary fisheries in rose red, and `強調解除` resets edge styling. Current live data contains 82 self-enemy fishery boundary edges, 464 enemy-unowned fishery boundary edges, 39 boundary #534 fishery nodes, and 55 self-depth edges.
