...
23. Added edge-highlight controls to the generated HTML map: selecting a fishery highlights its connected edges in cyan, `境界強調` highlights friendly-side (#534/#509/#440/#511 group) fishery to enemy-side fishery edges in orange and enemy-side fishery to unowned fishery edges in amber, `境界+内側` additionally highlights edges from friendly/enemy boundary friendly-side fisheries into friendly-side or unowned fisheries in rose red, and `強調解除` resets edge styling. Current live data contains 82 self-enemy fishery boundary edges, 279 ally-enemy fishery boundary edges, 464 enemy-unowned fishery boundary edges, 166 boundary friendly fishery nodes, and 322 friendly/unowned-depth edges. Example: `#534:D-13` is enemy, `#534:D-15` is self, `#534:D-17` is unowned, and `#534:D-15 -- #534:D-17` is now included in `境界+内側`.
