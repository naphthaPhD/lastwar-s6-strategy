...
23. Added edge-highlight controls to the generated HTML map: selecting a fishery highlights its connected edges in cyan, `境界強調` highlights friendly-side (#534/#509/#440/#511 group) fishery to enemy-side fishery edges in orange and enemy-side fishery to unowned fishery edges in amber, `境界+内側` additionally highlights friendly-side fishery edges touching friendly/enemy boundary fisheries in rose red, and `強調解除` resets edge styling. Current live data contains 82 self-enemy fishery boundary edges, 279 ally-enemy fishery boundary edges, 464 enemy-unowned fishery boundary edges, 166 boundary friendly fishery nodes, and 242 friendly-depth edges.
